...
@section('page-title', 'Data Author')
...
<div class="content-card">
    ...
    <div class="content-header">
        ...
        <div>
            <h2>Daftar Author</h2>
            <p>Kelola data penulis buku perpustakaan.</p>
        </div>

        <a href="{{ route('author.create') }}" class="btn-add">
                    ...
                    <td>
                        ...
                        <div class="actions">
                            ...
                            <form action="{{ route('author.destroy', $author->id) }}"
                                  method="POST"
                                  onsubmit="return confirm('Yakin ingin menghapus author ini?')">
